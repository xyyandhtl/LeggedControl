...
def main():
    ...
    p.add_argument("--jit", type=str, default="/home/nhy/Projects/embodied_deploy_ws_0805/src/cmit_loco/cmit_loco_ros2/cmit_loco_ros2/loco_deploy/HIMLoco/model/policy_Heading.pt", help="input TorchScript .pt")
